...
// Backend URL
const BACKEND_URL = "http://127.0.0.1:5000/api/emergency"; 
// Use your render URL when deployed
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  unsafeBtn.addEventListener("click", async () => {
    ...
    // Save full path to Firestore (optional but useful)
    try {
    ...
    // Clear path and restart tracking
    trackedPath = [];
    startTracking();
  });
});
